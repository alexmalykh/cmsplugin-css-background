...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilerCssBackground'
        db.create_table(u'cmsplugin_css_background_filercssbackground', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('color', self.gf('django.db.models.fields.CharField')(default=u'', max_length=32, blank=True)),
        ...
        db.send_create_signal(u'cmsplugin_css_background', ['FilerCssBackground'])


    def backwards(self, orm):
        # Deleting model 'FilerCssBackground'
        db.delete_table(u'cmsplugin_css_background_filercssbackground')
    ...
    models = {
        ...
        u'cmsplugin_css_background.cssbackground': {
            'Meta': {'object_name': 'CssBackground'},
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
        ...
        u'cmsplugin_css_background.filercssbackground': {
            'Meta': {'object_name': 'FilerCssBackground'},
            'attachment': ('django.db.models.fields.CharField', [], {'default': "'scroll'", 'max_length': '8'}),
            'bg_position': ('django.db.models.fields.CharField', [], {'default': "u'0% 0%'", 'max_length': '24', 'blank': 'True'}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
